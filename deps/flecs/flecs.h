...
#define FLECS_RULES         /**< Constraint32_t solver for advanced queries */
...
FLECS_API
const char* ecs_os_strerror(int32_t err);
...
typedef int32_t (*ecs_order_by_action_t)(
    ecs_entity_t e1,
    const void *ptr1,
    ecs_entity_t e2,
    const void *ptr2);
...
typedef int32_t (*ecs_compare_action_t)(
    const void *ptr1,
    const void *ptr2);
 ...
 * });
 *
 * int32_t food_var = ecs_rule_find_var(r, "Food");
 *
 ...
 */
FLECS_API
int32_t ecs_value_init_w_type_info(
    const ecs_world_t *world,
 ...
 * @return Zero if success, nonzero if failed.
 */
int32_t ecs_value_fini_w_type_info(
    const ecs_world_t *world,
    const ecs_type_info_t *ti,
    void *ptr);
 ...
 */
FLECS_API
int32_t ecs_value_copy_w_type_info(
    const ecs_world_t *world,
    const ecs_type_info_t *ti,
    void* dst,
    const void *src);
 ...
 * @return Zero if success, nonzero if failed.
 */
int32_t ecs_value_move_w_type_info(
    const ecs_world_t *world,
    const ecs_type_info_t *ti,
    void* dst,
    void *src);
 ...
 * @return Zero if success, nonzero if failed.
 */
int32_t ecs_value_move_ctor_w_type_info(
    const ecs_world_t *world,
    const ecs_type_info_t *ti,
    void* dst,
    void *src);
 ...
 * Example:
 *   int32_t CompareMyType(ecs_entity_t e1, const void* ptr1, ecs_entity_t e2, const void* ptr2) { const MyType* p1 = ptr1; const MyType* p2 = ptr2; return p1->value - p2->value; }
...
#define ECS_COMPARE(id, ...) \
    int32_t ecs_compare(id)(ecs_entity_t e1, const void* ptr1, ecs_entity_t e2, const void* ptr2) { \
        __VA_ARGS__ \
    }
 ...
 *
 * The logging addon can be disabled to reduce footprint32_t of the library, but
 ...
 */
FLECS_API
int32_t ecs_log_get_level(void);
 ...
 */
FLECS_API
int32_t ecs_log_last_error(void);
 ...
 */
FLECS_API
int32_t ecs_app_set_run_action(
 ...
 */
FLECS_API
int32_t ecs_app_set_frame_action(
 ...
 */
FLECS_API
int32_t ecs_http_server_http_request(
...
FLECS_API
int32_t ecs_http_server_request(
    ecs_http_server_t* srv,
    const char *method,
    const char *req,
    ecs_http_reply_t *reply_out);
...
/** Add color to entity.
 * UIs can use color as hint32_t to improve visualizing entities.
 *
 * @param world The world.
 * @param entity The entity to which to add the link.
 ...
 */
FLECS_API
int32_t ecs_type_info_to_json_buf(
    const ecs_world_t *world,
    ecs_entity_t type,
    ecs_strbuf_t *buf_out);
 ...
 */
FLECS_API
int32_t ecs_entity_to_json_buf(
    const ecs_world_t *world,
    ecs_entity_t entity,
    ecs_strbuf_t *buf_out,
    const ecs_entity_to_json_desc_t *desc);
...
typedef struct ecs_serializer_t {
    ...
    /* Serialize value */
    int32_t value(ecs_entity_t type, const void *value) const;

    /* Serialize value */
    template <typename T>
    int32_t value(const T& value) const;

    /* Serialize member */
    int32_t member(const char *name) const;
...
typedef int32_t (*ecs_meta_serialize_t)(
...
FLECS_API
int32_t ecs_meta_set_bool(
    ecs_meta_cursor_t *cursor,
    bool value);

/** Set field with char value */
FLECS_API
int32_t ecs_meta_set_char(
    ecs_meta_cursor_t *cursor,
    char value);

/** Set field with int32_t value */
FLECS_API
int32_t ecs_meta_set_int(
    ecs_meta_cursor_t *cursor,
    int64_t value);

/** Set field with uint32_t value */
FLECS_API
int32_t ecs_meta_set_uint(
    ecs_meta_cursor_t *cursor,
    uint64_t value);

/** Set field with float value */
FLECS_API
int32_t ecs_meta_set_float(
    ecs_meta_cursor_t *cursor,
    double value);

/** Set field with string value */
FLECS_API
int32_t ecs_meta_set_string(
    ecs_meta_cursor_t *cursor,
    const char *value);

/** Set field with string literal value (has enclosing "") */
FLECS_API
int32_t ecs_meta_set_string_literal(
    ecs_meta_cursor_t *cursor,
    const char *value);

/** Set field with entity value */
FLECS_API
int32_t ecs_meta_set_entity(
    ecs_meta_cursor_t *cursor,
    ecs_entity_t value);

/** Set field with null value */
FLECS_API
int32_t ecs_meta_set_null(
    ecs_meta_cursor_t *cursor);

/** Set field with dynamic value */
FLECS_API
int32_t ecs_meta_set_value(
    ecs_meta_cursor_t *cursor,
 ...
 */
FLECS_API
int32_t ecs_primitive_to_expr_buf(
    const ecs_world_t *world,
    ecs_primitive_kind_t kind,
    const void *data,
    ecs_strbuf_t *buf);
...
// More convenience templates. The if_*_t templates use int32_t as default type
...
{
    explicit array_iterator(T* value, int32_t index) {
        m_value = value;
        m_index = index;
    }
...
/** Int to enum */
namespace _ {
template <typename E, int32_t Value>
struct to_constant {
...
private:
    template <E Value>
    static constexpr int32_t to_int() {
    ...
    template <E Value>
    static constexpr int32_t is_not_0() {
...
struct enum_data {
    ...
    int32_t next(int32_t cur) const {
        return impl_.constants[cur].next;
    }

    flecs::entity entity() const;
    flecs::entity entity(int32_t value) const;
...
template <typename T>
struct arity {
    static constexpr int32_t value = _::function_traits<T>::arity;
};
...
struct cursor {
    ...
    int32_t member(const char *name) {
    ...
    /** Set boolean value */
    int32_t set_bool(bool value) {
        return ecs_meta_set_bool(&m_cursor, value);
    }

    /** Set char value */
    int32_t set_char(char value) {
        return ecs_meta_set_char(&m_cursor, value);
    }

    /** Set signed int32_t value */
    int32_t set_int(int64_t value) {
        return ecs_meta_set_int(&m_cursor, value);
    }

    /** Set unsigned int32_t value */
    int32_t set_uint(uint64_t value) {
        return ecs_meta_set_uint(&m_cursor, value);
    }

    /** Set float value */
    int32_t set_float(double value) {
        return ecs_meta_set_float(&m_cursor, value);
    }

    /** Set string value */
    int32_t set_string(const char *value) {
        return ecs_meta_set_string(&m_cursor, value);
    }

    /** Set string literal value */
    int32_t set_string_literal(const char *value) {
        return ecs_meta_set_string_literal(&m_cursor, value);
    }

    /** Set entity value */
    int32_t set_entity(flecs::entity_t value) {
    ...
    /** Get signed int32_t value */
    int64_t get_int() const {
        return ecs_meta_get_int(&m_cursor);
    }

    /** Get unsigned int32_t value */
...
struct app_builder {
    ...
    int32_t run() {
        int32_t result = ecs_app_run(m_world, &m_desc);
...
/** Set log level */
inline void set_level(int32_t level) {
...
struct world {
     ...
     */
    explicit world(int32_t argc, char *argv[])
     ...
     */
    int32_t count(flecs::id_t component_id) const {
     ...
     * @param second The second element of the pair.
     */
    int32_t count(flecs::entity_t first, flecs::entity_t second) const {
     ...
     */
    template <typename First>
    int32_t count(flecs::entity_t second) const {
 ...
 */
int32_t plecs_from_str(const char *name, const char *str) const {
 ...
 */
int32_t plecs_from_file(const char *filename) const {
...
struct column {
     ...
     */
    column(iter &iter, int32_t column);
...
public:
     ...
     */
    flecs::entity get_var(int32_t var_id) const;
...
private:
    ...
    template <template<typename X, typename = int> class ColumnType,
        typename... Args, int32_t Enabled = PassIter, if_t<
...
struct iter_iterable final : iterable<Components...> {
    ...
    iter_iterable<Components...>& set_var(int32_t var_id, flecs::entity_t value) {
...
iter_iterable<Components...>& set_var(const char *name, flecs::entity_t value) {
    ...
    int32_t var_id = ecs_rule_find_var(rit->rule, name);
...
struct filter_base {
    ...
    void each_term(const Func& func) {
        for (int32_t i = 0; i < m_filter_ptr->term_count; i ++) {
...
struct query_base {
    ...
    void each_term(const Func& func) const {
        ...
        for (int32_t i = 0; i < f->term_count; i ++) {
...
inline flecs::opaque<EntityType> flecs_entity_support(flecs::world&) {
    return flecs::opaque<EntityType>()
        ...
        .serialize([](const flecs::serializer *ser, const EntityType *data) -> int32_t {
...
inline int32_t ecs_serializer_t::value(ecs_entity_t type, const void *v) const {
    return this->value_(this, type, v);
}

template <typename T>
inline int32_t ecs_serializer_t::value(const T& v) const {
    return this->value(flecs::_::cpp_type<T>::id(
        const_cast<flecs::world_t*>(this->world)), &v);
}

inline int32_t ecs_serializer_t::member(const char *name) const {
...
#ifdef FLECS_RULES
inline flecs::entity iter::get_var(int32_t var_id) const {
...
inline flecs::entity iter::get_var(const char *name) const {
    ...
    int32_t var_id = ecs_rule_find_var(r, name);
    ecs_assert(var_id != -1, ECS_INVALID_PARAMETER, name);
    return flecs::entity(m_iter->world, ecs_iter_get_var(m_iter, var_id));
}
#endif
...
template <typename E>
inline flecs::entity enum_data<E>::entity(int32_t value) const {
