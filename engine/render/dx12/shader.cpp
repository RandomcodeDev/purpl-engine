...
static CONST D3D12_INPUT_ELEMENT_DESC MeshInputElementDescriptions[] = {
    {"POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(MESH_VERTEX, Position),
     D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
    {"COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, offsetof(MESH_VERTEX, Colour),
     D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
    {"TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT, 0, offsetof(MESH_VERTEX, TextureCoordinate),
     D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
    {"NORMAL", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, offsetof(MESH_VERTEX, Normal), D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA,
     0}};
