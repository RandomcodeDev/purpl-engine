 ...
 */
VkDevice create_logical_device(VkPhysicalDevice physical_device, struct queue_family_indices indices, VkQueue *graphics_queue_handle, VkQueue *present_queue_handle);
}
